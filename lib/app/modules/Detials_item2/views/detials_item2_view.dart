...
class DetialsItem2View extends GetView<DetialsItem2Controller> {
  ...
  Widget build(BuildContext context) {
    ...
    Get.toNamed(Routes.CART) ;               
      ...
      body:GetBuilder<DetialsItem2Controller>(
                  init: DetialsItem2Controller(),
                  initState: (_) {},
                  builder: (_) {
