...
import 'package:qcafe/app/modules/Otp/controllers/otp_controller.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Center(
                                        ...
                                        child: CircleAvatar(
                                          ...
                                          child: GestureDetector(
                                            ...
                                            child: ColorSonar(
                                              ...
                                              innerWaveColor: Theme.of(context).primaryColor,
                                              middleWaveColor: Theme.of(context).primaryColor.withOpacity(.4),
                                              outerWaveColor:kwhite.withOpacity(.4) ,
          // wavesDisabled: true,
          ...
          waveMotion: WaveMotion.synced,
          // duration: Duration(seconds: 5),
          child:Text("تأكيد",style: TextStyle(color: Theme.of(context).primaryColor,fontWeight: FontWeight.bold),)),
                                          )));
