...
class ConfirmOrderDeliveryView extends GetView<ConfirmOrderDeliveryController> {
  const ConfirmOrderDeliveryView({Key? key}) : super(key: key);
  @override
        ...
        body: Column(
          children: [
            ...
            Padding(
              ...
              child: MainButton(text: "إدفع الان", press: () {}),
            ),
